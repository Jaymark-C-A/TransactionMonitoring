...
<body class="text-sm" style="background-color: #cecece">
    <div class="wrapper">
        ...
        <div class="content-wrapper" style="background-color: transparent">
            ...
            <div class="content">
                <div class="container-fluid"> <!-- Recent Transactions Section -->
                    <div class="row mb-4">
                        <div class="col-lg-12">
                    ...
                    <div class="row"> <!-- Main Transaction History Table -->
                        <div class="col-lg-12">
                            <div class="card smoky-shadow">
                                <div class="card-header text-white" style="background-color: #4b5c1c">
                                    <h5 class="card-title mb-0">Accounting Department Transactions</h5>
                                </div>
                                <div class="card-body">
                                    <table id="transactionTable" class="table table-bordered table-striped transaction-table">
                                        ...
                                        <tbody>
                                            @foreach($accountingVisitors as $visitor)
                                                <tr>
                                                    <td>{{ $visitor->name }}</td>
