        ...
        <div class="content-wrapper" style="background-color: transparent">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <a href="accounting/dashboard" class="breadcrumb-item active">Dashboard</a>
            ...
            <div class="container w-100 bg-light p-2 smoky-shadow">
                ...
                <div class="col-md-12 text-right my-3">
                    <button class="btn btn-primary"><a href="/accounting/reports/printEx" class="text-white">Print Report</a></button>
                </div>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.length > 0) {
                            ...
                            const clinicFeedback = response.filter(feedback => feedback.Office === 'Accounting');
                            ...
                            $('#feedbackTableBody').append('<tr><td colspan="10" class="text-center">No feedback available</td></tr>');
                        }
                    },
                    error: function(xhr) {
