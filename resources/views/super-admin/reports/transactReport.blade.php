    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper" style="background-color: transparent">
            ...
            <div class="container p-4 bg-light smoky-shadow">
                ...
                <div id="report-content" class="table-wrapper p-2 bg-light">
...
<script>
    $('#print-button').click(function() {
        ...
        if ($('#report-content tbody').text().includes('No data available in table')) {
            totalTransactions = 0; // Set count to zero if the message is present
        } else {
            // Count the number of rows in the table
            totalTransactions = $('#report-content tbody tr').length;
        }
        ...
        $('#report-content tbody tr').each(function() {
...
printIframe.contentWindow.print();
        ...
        // const ctx = printWindow.document.getElementById('departmentPieChart').getContext('2d');
        ...
        //         labels: labels,
        //         datasets: [{
        //             label: 'Transactions by Department',
        //             data: data,
        //             backgroundColor: [
