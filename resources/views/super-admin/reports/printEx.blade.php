...
<div class="mb-2 px-4">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6">
                <p><strong>School:</strong> Olongapo City National High School</p>
                <p><strong>Date Covered:</strong> <span id="dateRanges2">N/A</span></p>
                <p><strong>Division:</strong> SDO Olongapo City</p>
            </div>                
            <div class="col-md-4">
                <p><strong>Office Visited:</strong> ADMIN UNIT</p>
                <p><strong>School Year:</strong> 
                    <?php
                    $currentYear = date('Y');
                    $nextYear = $currentYear + 1;
...
// Fetch survey responses from the database
$responses = SurveyResponse::where('Office', 'Admin')->get(); // Adjust as needed
$totalResponses = $responses->count(); // Initialize $totalResponses here
    ...
    <div class="container-fluid py-5">
        <div class="row">
            ...
            <div class="col-md-8">
                <h1>Analysis:</h1>
                <?php if ($totalResponses > 0): ?>
                    <p>The client satisfaction survey form was conducted on <span id="dateRanges3">N/A</span>, and there are <?= $totalResponses ?> respondents in total.</p>
                    <p>Based on the submitted survey form, <?= $overallSatisfactionPercentage ?>% of respondents were “Strongly Agree” across all criteria:
                        criteria no. 1 (Service Satisfaction), criteria no. 2 (Waiting Time Satisfaction), criteria no. 3 (Procedure Accuracy), criteria no. 4 (Ease of Process), criteria no. 5 (Clarity of Information), criteria no. 6 (Impartiality), criteria no. 7 (Customer Service Quality) and criteria no. 8 (Outcome Satisfaction).</p>
                <?php else: ?>
                    <p>No survey data available for analysis.</p>
...
<div class="mb-2 px-4">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6">
                <p><strong>School:</strong> Olongapo City National High School</p>
                <p><strong>Date Covered:</strong> <span id="dateRanges4">N/A</span></p>
                <p><strong>Division:</strong> SDO Olongapo City</p>
            </div>                
            <div class="col-md-4">
                <p><strong>Office Visited:</strong> GUIDANCE UNIT</p>
                <p><strong>School Year:</strong> 
                    <?php
                    $currentYear = date('Y');
                    $nextYear = $currentYear + 1;
...
// Fetch survey responses from the database
$responses = SurveyResponse::where('Office', 'Guidance')->get(); // Adjust as needed
$totalResponses = $responses->count(); // Initialize $totalResponses here
    ...
    <div class="container-fluid py-5">
        <div class="row">
            ...
            <div class="col-md-8">
                <h1>Analysis:</h1>
                <?php if ($totalResponses > 0): ?>
                    <p>The client satisfaction survey form was conducted on <span id="dateRanges5">N/A</span>, and there are <?= $totalResponses ?> respondents in total.</p>
                    <p>Based on the submitted survey form, <?= $overallSatisfactionPercentage ?>% of respondents were “Strongly Agree” across all criteria:
                        criteria no. 1 (Service Satisfaction), criteria no. 2 (Waiting Time Satisfaction), criteria no. 3 (Procedure Accuracy), criteria no. 4 (Ease of Process), criteria no. 5 (Clarity of Information), criteria no. 6 (Impartiality), criteria no. 7 (Customer Service Quality) and criteria no. 8 (Outcome Satisfaction).</p>
                <?php else: ?>
                    <p>No survey data available for analysis.</p>
...
<div class="mb-2 px-4">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6">
                <p><strong>School:</strong> Olongapo City National High School</p>
                <p><strong>Date Covered:</strong> <span id="dateRanges6">N/A</span></p>
                <p><strong>Division:</strong> SDO Olongapo City</p>
            </div>                
            <div class="col-md-4">
                <p><strong>Office Visited:</strong> CLINIC UNIT</p>
                <p><strong>School Year:</strong> 
                    <?php
                    $currentYear = date('Y');
                    $nextYear = $currentYear + 1;
...
// Fetch survey responses from the database
$responses = SurveyResponse::where('Office', 'Clinic')->get(); // Adjust as needed
$totalResponses = $responses->count(); // Initialize $totalResponses here
    ...
    <div class="container-fluid py-5">
        <div class="row">
            ...
            <div class="col-md-8">
                <h1>Analysis:</h1>
                <?php if ($totalResponses > 0): ?>
                    <p>The client satisfaction survey form was conducted on <span id="dateRanges7">N/A</span>, and there are <?= $totalResponses ?> respondents in total.</p>
                    <p>Based on the submitted survey form, <?= $overallSatisfactionPercentage ?>% of respondents were “Strongly Agree” across all criteria:
                        criteria no. 1 (Service Satisfaction), criteria no. 2 (Waiting Time Satisfaction), criteria no. 3 (Procedure Accuracy), criteria no. 4 (Ease of Process), criteria no. 5 (Clarity of Information), criteria no. 6 (Impartiality), criteria no. 7 (Customer Service Quality) and criteria no. 8 (Outcome Satisfaction).</p>
                <?php else: ?>
                    <p>No survey data available for analysis.</p>
...
<div class="mb-2 px-4">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6">
                <p><strong>School:</strong> Olongapo City National High School</p>
                <p><strong>Date Covered:</strong> <span id="dateRanges8">N/A</span></p>
                <p><strong>Division:</strong> SDO Olongapo City</p>
            </div>                
            <div class="col-md-4">
                <p><strong>Office Visited:</strong> ACCOUNTING UNIT</p>
                <p><strong>School Year:</strong> 
                    <?php
                    $currentYear = date('Y');
                    $nextYear = $currentYear + 1;
...
// Fetch survey responses from the database
$responses = SurveyResponse::where('Office', 'Accounting')->get(); // Adjust as needed
$totalResponses = $responses->count(); // Initialize $totalResponses here
    ...
    <div class="container-fluid py-5">
        <div class="row">
            ...
            <div class="col-md-8">
                <h1>Analysis:</h1>
                <?php if ($totalResponses > 0): ?>
                    <p>The client satisfaction survey form was conducted on <span id="dateRanges9">N/A</span>, and there are <?= $totalResponses ?> respondents in total.</p>
                    <p>Based on the submitted survey form, <?= $overallSatisfactionPercentage ?>% of respondents were “Strongly Agree” across all criteria:
                        criteria no. 1 (Service Satisfaction), criteria no. 2 (Waiting Time Satisfaction), criteria no. 3 (Procedure Accuracy), criteria no. 4 (Ease of Process), criteria no. 5 (Clarity of Information), criteria no. 6 (Impartiality), criteria no. 7 (Customer Service Quality) and criteria no. 8 (Outcome Satisfaction).</p>
                <?php else: ?>
                    <p>No survey data available for analysis.</p>
