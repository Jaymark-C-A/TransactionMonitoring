        ...
        <div class="content-wrapper bg-transparent">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item"><a href="monitor">Monitoring</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="current-ticket smoky-shadow m-0 p-0" style="background: #e69430; color: white;">
                            <div class="card-header mb-5 text-left" style="background: #d68725; color: white;">
