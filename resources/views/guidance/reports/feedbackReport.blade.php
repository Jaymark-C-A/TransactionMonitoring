        ...
        <div class="content-wrapper" style="background-color: transparent">
            ...
            <div class="container w-100 bg-light p-2 smoky-shadow">
                ...
                <div class="col-md-12 text-right my-3">
                    <button class="btn btn-primary"><a href="/guidance/reports/printEx" class="text-white">Print Report</a></button>
                </div>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.length > 0) {
                            ...
                            const clinicFeedback = response.filter(feedback => feedback.Office === 'Guidance');
