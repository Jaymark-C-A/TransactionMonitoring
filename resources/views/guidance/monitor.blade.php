    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper bg-transparent">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="current-ticket smoky-shadow m-0 p-0" style="background: #c4436e;">
                        <div class="card-header mb-5 text-left" style="background: #a8395e; color: white;">
...
{{-- <script>
    function fetchPendingHeadVisitors() {
        fetch('/api/visitors/pending-Head-info', {
            method: 'GET',
            headers: {
