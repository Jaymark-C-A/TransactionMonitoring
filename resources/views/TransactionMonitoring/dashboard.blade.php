                ...
                <div class="container-fluid bg-transparent py-2">
                    ...
                    <div class="container-fluid p-0">
                        <div class="row p-0">
                            ...
                            <section class="col-lg-12 col-md-3 connectedSortable">
                                <div class="card smoky-shadow">
                                    <div class="card-header border-0" style="background: rgb(20, 129, 165);">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <a href="/TransactionMonitoring/reports/transactReport" class="text-bold text-lg" style="color: #FFFFFF;">View Report</a>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="d-flex">
                                ...
                                <div class="card smoky-shadow">
                                    <div class="card-header border-0"  style="background: rgb(214, 131, 6);">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <a href="/TransactionMonitoring/reports/feedbackReport" class="text-bold text-lg" style="color: #FFFFFF;">View Report</a>
                                        </div>
                                    </div>
                                    <div class="card-body">
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#infoModal').on('show.bs.modal', function (event) {
                ...
                var modal = $(this);
                modal.find('.modal-body #modal-info-content').text(info);
            });
        });
    </script>
