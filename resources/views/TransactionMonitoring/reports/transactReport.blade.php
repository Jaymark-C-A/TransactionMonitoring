...
<body class="text-sm" style="background-color: #cecece">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4 position-fixed">
            @include('includes.sidebar.sidebar-principal')  
        </aside>
        <div class="content-wrapper" style="background-color: transparent">
            ...
            <div class="container p-4 bg-light smoky-shadow">
                ...
                <div id="report-content1" class="table-wrapper p-2 bg-light">
        ...
        function fetchReportData(startDate, endDate, query, department) {
            ...
            $.ajax({
                ...
                success: function(data) {
                            ...
                            <tbody>
                                ...
                                .filter(visitor => visitor.status.toLowerCase() !== 'waiting' && visitor.status.toLowerCase() !== 'serving')                                    .map(visitor => `
                                        <tr>
                                            ...
                                            <td>${visitor.department ? visitor.department : 'N/A'}</td>
                    ...
                    `;
                    $('#report-content1').html(content);

                                // Initialize DataTable
                    $('#visitorTable').DataTable();
                },
                error: function() {
                    $('#report-content1').html('<p>Error loading report data.</p>');
                }
            });
        }
...
<script>
    $('#print-button').click(function() {
        ...
        if ($('#report-content1 tbody').text().includes('No data available in table')) {
            totalTransactions = 0; // Set count to zero if the message is present
        } else {
            // Count the number of rows in the table
            totalTransactions = $('#report-content1 tbody tr').length;
        }
        ...
        $('#report-content1 tbody tr').each(function() {
        ...
        <body>
            ...
            <main>
                ...
                <div class="analysis col-md-7">
                    ...
                    <p>Based on the submitted survey form, ${statusCounts.completed} out of ${totalTransactions} respondents are marked as “Completed” and ${statusCounts.canceled} out of ${totalTransactions} are marked as "Canceled" across all departments.</p>
                </div>
