...
<div class="sidebar">
    ...
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <a href="/admin-guard/dashboard" class="nav-link nav-text" style="background: rgb(6, 193, 255);">
        ...
        <li class="nav-item">
            <a href="/admin-guard/profile" class="nav-link nav-text">
        ...
        <ul class="nav nav-treeview">
          <li class="nav-item ">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="/account_setting/admin-guard/account-guard" class="nav-link nav-text">
                        <i class="fas fa-user-alt" style="font-size:24px; padding-right: 10px;"></i>
                        <p class="text-sm">Account</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="/account_setting/admin-guard/password-guard" class="nav-link nav-text">
                        <i class="fas fa-lock" style="font-size:24px; padding-right: 10px;"></i>
