...
<div class="sidebar">
    <ul class="navbar-nav" style="display: flex; justify-content: center; align-items: center; padding-top:20px;">
        <li class="nav-item">
            <a id="hamburger-menu" class="nav-link" data-widget="pushmenu" href="/records/dashboard" role="button">
        ...
        <li class="nav-item" style="margin-left: auto; margin-right: auto;">
            <a href="/records/dashboard" class="nav-item">TRANSACTION MONITORING</a>
        </li>
    </ul>
    ...
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                <a href="/records/reports/transactReport" class="nav-link nav-text py-2">
                    <i class="fas fa-clipboard-list" style="font-size: 16px; padding-right: 10px; text-indent: 20px;"></i>
                    <p class="text-md">Transactions</p>
                </a>
                </li>
                <li class="nav-item">
                <a href="/records/reports/feedbackReport" class="nav-link nav-text py-2">
                    <i class="fas fa-clipboard-list" style="font-size: 16px; padding-right: 10px; text-indent: 20px;"></i>
