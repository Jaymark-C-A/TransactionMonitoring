...
<div class="sidebar">
    ...
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <a href="/department-head/dashboard" class="nav-link nav-text" style="background: rgb(6, 193, 255);">
        ...
        <li class="nav-item">
            <a href="/department-head/profile" class="nav-link nav-text">
        ...
        <ul class="nav nav-treeview">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="/account_setting/department-head/account-offices" class="nav-link nav-text">
                        <i class="fas fa-user-alt" style="font-size:24px; padding-right: 10px; text-indent: 20px;"></i>
                        <p class="text-sm">Account</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="/account_setting/department-head/password-offices" class="nav-link nav-text">
