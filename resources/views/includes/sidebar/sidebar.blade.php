...
<div class="sidebar">
    <ul class="navbar-nav" style="display: flex; justify-content: center; align-items: center; padding-top:20px;">
        ...
        <li class="nav-item" style="margin-left: auto; margin-right: auto;">
            <a href="/super-admin/dashboard" class="nav-item">TRANSACTION MONITORING</a>
        </li>
    </ul>
    ...
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
        <a href="/super-admin/dashboard" class="nav-link py-2">
        ...
        <li class="nav-item">
        <a href="/super-admin/view" class="nav-link nav-text py-2 ">
        ...
        <li class="nav-item">
            <a href="#" class="nav-link nav-text py-2">
                <i class="fa fa-bar-chart" aria-hidden="true" style="font-size: 16px; padding-right: 8px;"></i>
                <p class="text-md">Reports</p>
                <i class="right fa fa-angle-down" style="font-size:20px"></i>
            </a>
            <ul class="nav nav-treeview">
                <li class="nav-item">
                <a href="/super-admin/reports/transactReport" class="nav-link nav-text py-2">
                    <i class="fas fa-clipboard-list" style="font-size: 16px; padding-right: 10px; text-indent: 20px;"></i>
                    <p class="text-md">Transactions</p>
                </a>
                </li>
                <li class="nav-item">
                <a href="/super-admin/reports/feedbackReport" class="nav-link nav-text py-2">
                    <i class="fas fa-clipboard-list" style="font-size: 16px; padding-right: 10px; text-indent: 20px;"></i>
        ...
        <li class="nav-item">
            <a href="/super-admin/profile" class="nav-link nav-text py-2">
                <i class="fas fa-user-circle" style="font-size: 16px; padding-right: 10px;"></i>
                <p class="text-md">Profile</p>
            </a>
        </li>
        <li class="nav-item">
            <a href="/administrators" class="nav-link nav-text py-2">
                <i class="fa-solid fa-user-tie" style="font-size: 16px; padding-right: 10px;"></i>
                <p class="text-md">Personnels</p>
            </a>
        </li>
        <li class="nav-item">
                <a href="/super-admin/archive" class="nav-link nav-text py-2">
                    <i class="fas fa-archive" style="font-size: 16px; padding-right: 10px;"></i>
                    <p class="text-md">Archive</p>
                </a>
        </li>
        <li class="nav-item">
            <a href="{{ url('users') }}" class="nav-link nav-text py-2">
                <i class="fas fa-user-plus" style="font-size: 16px; padding-right: 10px;"></i>
                <p class="text-md">Create Account</p>
            </a>
        </li>
        <li class="nav-item">
            <a href="/backup" class="nav-link nav-text py-2">
                <i class="fas fa-sync-alt arrow" style="font-size: 16px; padding-right: 10px;"></i>
                <p class="text-md">Backup</p>
            </a>
        </li>
        </ul>
